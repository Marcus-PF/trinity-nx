...
const highlights = [
  ...
  },
  {
    ...
    icon: HeartHandshake,
    description: 'Empowering members and youth through guided learning and Rotary values.',
  },
  {
    title: 'Education Outreach',
    icon: GraduationCap,
    description: 'School supply drives, tutoring support, and facility upgrades.',
  },
]
    ...
    >
      <div className="max-w-6xl mx-auto text-center mb-12 space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Real-world initiatives led by real people. Here’s how we’re building a better tomorrow.
        </p>
      </div>
        ...
        {highlights.map((item, index) => {
          ...
          return (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="h-full bg-muted border border-border shadow-sm">

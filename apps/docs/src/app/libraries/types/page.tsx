  ...
  return (
    <>
      <section className="container mx-auto py-16 px-4 text-center">
        <h1 className="text-4xl font-bold mb-4">Welcome to the @trinity/types library docs</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <Card>
            <CardHeader>
              ...
              <CardDescription>This is the @trinity/types library Docs</CardDescription>
            </CardHeader>
            <CardContent>
